...
import { Filters, ChartData } from '../types';
...
const ChartGrid: React.FC<ChartGridProps> = ({ filters }) => {
  const [salesByYear, setSalesByYear] = useState<ChartData | null>(null);
  const [volumeByYear, setVolumeByYear] = useState<ChartData | null>(null);
  const [yearWiseSalesVertical, setYearWiseSalesVertical] =
    useState<ChartData | null>(null);
  const [monthlyTrend, setMonthlyTrend] = useState<ChartData | null>(null);
  const [marketShare, setMarketShare] = useState<ChartData | null>(null);
